...
<div className="order-1 text-center lg:text-left">
  ...
  {/* Status Badge */}
          ...
          <div className="order-2 flex justify-center mt-8 lg:mt-0">

            <div className="relative w-[220px] h-[220px] sm:w-[300px] sm:h-[300px] lg:w-[520px] lg:h-[520px] sm:w-[260px] sm:h-[260px] lg:w-[520px] lg:h-[520px]">
              {/* Main Glow */}
              ...
              <div className="absolute inset-6 rounded-full border border-cyan-400/30 bg-white/5 backdrop-blur-xl flex items-center justify-center shadow-[0_0_60px_rgba(34,211,238,0.25)]">
